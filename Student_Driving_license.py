...
def driver_license(): 
    label_id=24
    print(label_id)
    label_name="Barack Obama"
    label_dob= "9/11/2001"
    label_pin= 123456
    label_address= "308 negra arroyo lane 81760"
    label_vehicle_type="4 wheeler"
    label_id['text']="label Id"

    
# Create a button

button1=Button(root, text="Drivers License", command=driver_license)
